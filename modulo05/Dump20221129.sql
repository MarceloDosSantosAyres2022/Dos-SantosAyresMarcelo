CREATE DATABASE  IF NOT EXISTS `alpha-silicon` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `alpha-silicon`;
...
INSERT INTO `cursos` VALUES (1,'Introducción a la programación',NULL,'1'),(2,'Programación full stack',NULL,'1'),(3,'Data & Analytics',NULL,'1'),(4,'Diseño e impresión 3D',NULL,'1'),(5,'Innovación Digital',NULL,'1');
...
INSERT INTO `materias` VALUES (1,'INGLES1','Aprender inglés basico','Cinco módulos','1'),(2,'INGLES2','Aprender inglés intermedio','seis unidades','1'),(3,'INGLES1','Programación Web','seis módulos y un trabajo integrador','1'),(4,'INGLES1','Base de datos','Cinco módulos','1'),(5,'INGLES1','Programación de Apps','10 unidades','1');
...
INSERT INTO `usuarios` VALUES (1,'AarónRivero','aaronriv@email.com','0000','1'),(2,'AdelaSalas','adelas@email.com','0000','1'),(3,'AdolfoRubio','adolfr@email.com','0000','1'),(4,'AdriánSuárez','adrians@email.com','0000','1'),(5,'MarcosLoyola','Marcosl@email.com','0000','1');
...
-- Dump completed on 2022-12-20 18:33:24
